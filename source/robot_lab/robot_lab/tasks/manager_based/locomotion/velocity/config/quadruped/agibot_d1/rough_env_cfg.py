...
##
# use local assets
from robot_lab.assets.agibot import AGIBOT_D1_CFG  # isort: skip
...
class AgibotD1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Others
        self.rewards.feet_air_time.weight = 0.1  # 鼓励抬腿迈步
        self.rewards.feet_air_time.params["threshold"] = 0.5
        self.rewards.feet_air_time.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_air_time_variance.weight = -1.0  # 惩罚步态不均匀
        ...
        self.rewards.feet_slide.weight = -0.1  # 惩罚脚滑动
        ...
        self.rewards.feet_gait.weight = 0.5  # 鼓励对角步态
